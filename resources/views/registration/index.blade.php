        ...
        <div class="p-3 mb-2 bg-success w-96 h-max flex flex-col rounded-lg">
            ...
            <div>
                <form action="" method="post" class="flex flex-col p-3 gap-3">
                    ...
                    <input class="border rounded-xl text-center p-2 " type="text" name="email" id="email" placeholder="Email...">
                    <input class="border rounded-xl text-center p-2 " type="password" name="password" id="password" placeholder="Password...">
                    <div class="flex">
                        <button type="submit" class="bg-blue-500 p-2 w-24 text-white font-medium rounded-lg py-2.5 px-7">Register</button>
                    </div>
                    <span class="text-sm"><a href="/login" style="color: rgb(103, 241, 241)">Kembali Ke Halaman Login !</a></span>
                </form>
            </div>
        </div>
    </div>
